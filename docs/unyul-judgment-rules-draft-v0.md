...
| 항목 | ID | 상태 | 비고 |
|------|-----|------|------|
| 년/월/일/시 **위치 가중** | **TBD-01c-position** | **미정 · 미착수** | 본 확정은 전 슬롯 **균등(δ=4)**. 월지 가중은 §1.2 통근 2순위와 상호작용 → 별도 설계. 도입 시 §1.6.8.5.1 불변식(최대 Level 이동 1) **재검증 필수**. 실효 δ 상한은 **10**(§1.6.8.3) |
...
| 위치 가중 (년/월/일/시) | **미정 · 미착수 (TBD-01c-position)** — 현재 전 슬롯 균등 |
