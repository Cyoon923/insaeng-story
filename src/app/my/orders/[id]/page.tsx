...
export default async function OrderDetailPage({
    ...
    return (
      <MobileShell>
        ...
        <div className="px-4 py-10 text-center">
          <p className="text-[15px] text-[#8b6f5c]">로그인하면 주문 상세를 볼 수 있습니다.</p>
          <Link
            href="/login"
  ...
  return (
    <MobileShell>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h2 className="font-serif text-[22px] font-bold text-[#3d2b1f]">{order.title}</h2>
      ...
      <section className="px-4 pb-5">
        <h3 className="mb-3 text-[17px] font-bold text-[#3d2b1f]">주문 정보</h3>
        <div className="rounded-2xl bg-white p-4 ring-1 ring-[#ebe3d8]">
          <p className="text-[15px] font-semibold text-[#3d2b1f]">{order.title}</p>
          <div className="mt-3 space-y-2">
            ...
            <div>
              <p className="text-[13px] text-[#8b6f5c]">결제수단</p>
      ...
      <section className="px-4 pb-8">
        <div className="rounded-2xl bg-[#f5efe6] p-4 text-center">
          ...
          <p className="mt-1 text-[22px] font-bold text-[#5c3d2e]">{formatPrice(order.amount)}</p>
        </div>
      </section>
    </MobileShell>
  );
