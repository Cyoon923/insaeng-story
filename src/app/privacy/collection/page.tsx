      ...
      <div className="space-y-4 px-4 pb-8">
        ...
        <section className="rounded-2xl bg-white p-4 ring-1 ring-[#ebe3d8]">
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-[#5c3d2e]">
            ...
            인증번호는 본인 확인이 끝나면 바로 지워집니다. 가입을 마치면 인증에 사용한 정보도
            함께 지워집니다. 가입을 중간에 그만두신 경우에는 일정 시간이 지나면 더 이상 사용할 수
            없게 되며, 같은 번호로 다시 인증하시면 이전 값은 새 값으로 바뀝니다.
          </p>
        </section>
