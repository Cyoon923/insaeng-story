/**
 * 1900–2100 음력 월 정보.
 * bit0-3: 윤달 번호(0이면 없음), bit16: 윤달 30일 여부, bit4-15: 1–12월 대소.
 * 음력 1900-1-1 = 양력 1900-01-31.
 */
export const LUNAR_YEAR_MIN = 1900;
export const LUNAR_YEAR_MAX = 2100;
export const LUNAR_EPOCH_SOLAR = { year: 1900, month: 1, day: 31 } as const;
